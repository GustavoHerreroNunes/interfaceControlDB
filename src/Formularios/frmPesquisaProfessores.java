...
public class frmPesquisaProfessores extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmPesquisaProfessores frame = new frmPesquisaProfessores();
	...
	public frmPesquisaProfessores() {
		...
		JLabel lblCodigo = new JLabel("Insira o c\u00F3digo do Professor:");
		...
		JLabel lblNome = new JLabel("Insira o nome do Professor:");
